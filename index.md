...
- `original device`, `portable`, `light`
- `circuit`, `firmware`
- `arduino`
...
- Lightsaber
- `original device`, `portable`
- `circuit`, `firmware`, `system`
- `arduino`, `max`

[2019.12] [Perfume Challenger PV](https://www.youtube.com/watch?v=Bs-ZC7k_1k8)
- Wearable Light
- `original device`, `wearable`
- `circuit`, `firmware`
- `arduino`
...
- `original device`, `portable`, `haptic`
- `circuit`, `firmware`
- `arduino`
...
- `original device`, `motion control`
- `system`
- `ethercat`, `openframeworks`, `max`

[2018.07] [echo](https://research.rhizomatiks.com/s/works/echo/) ver.2 / 日本科学未来館
- Wearable Haptic Cloth + Portable Haptic Device (+ Take Session)
- `original device`, `haptic`, `wearable`, `sensing`
- `circuit`, `firmware`, `system`, `visual`, `pm`
...
- `original device`, `wearable`, `sensing`
- `circuit`
- `arduino`
...
- Moving Ring Light
- `original device`, `light`, `motion`
- `system`, `lighting design`, `motion design`
- `openframeworks`, `max`
...
- `original device`, `wearable`, `haptic`, `sensing`
- `circuit`, `firmware`, `system`, `pm`
- `arduino`, `max`
...
- Moving AWA Light
- `original device`, `light`, `motion`
- `circuit`, `firmware`, `system`, `motion design`, `operation`
- `openframeworks`, `max`
...
- `original device`, `light`, `wearable`
- `circuit`, `firmware`, `system`, `lighting design`, `operation`
- `openframeworks`, `max`
...
- VJ + Camera Control
- `original device`, `vj`
- `circuit`, `firmware`, `system`, `visual`
- `arduino`, `openframeworks`, `max`

[2015.09] [Perfume Anniversary 10days 2015 PPPPPPPPPP](https://www.youtube.com/watch?v=Qd-2QPXVCG8)
...
- `original device`, `sensing`
- `circuit`, `firmware`
- `arduino`

[2014.12] [永山祐子 | Yuko Nagayama x Space Player](https://www.youtube.com/watch?v=y4cI-kD-zbU) / Bamboo Expo 6
- Film Bending Device
- `original device`, `motion`
- `circuit`, `firmware`
- `arduino`
...
[GitHub](https://github.com/hideakitai) / [Twitter](https://twitter.com/hideakitai_) / [Instagram](https://www.instagram.com/hideakitai_/)  

[2015-] Hardware Engineer / Programmer at [Rhizoamtiks](https://rhizomatiks.com/)  
